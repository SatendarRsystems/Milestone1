...
export class LoginComponent implements OnInit, AfterViewInit {
    ...
    this.vidyoClientService.meetingJoinedConfirmed$.subscribe(
      status => {
        switch (status.type) {
          ...
          case string_constant.DISCONNECTED: // disconnected
          case string_constant.FAILED: // Failed
            this.isLoading = false;
            this.errorOccured = true;
            this.connectionStatus.nativeElement.innerHTML = string_constant.UNABLE_TO_JOIN;
            break;
  ...
  joinMeeting() {
    ...
    this.vidyoClientService.setData(this.login.userName, this.login.meetingRoom);
    this.isLoading = true;
  ...
  validateInput() {
    ...
    if (this.login.userName === '' || !this.login.userName.match(letters)) {
      this.errorOccured = true;
      this.connectionStatus.nativeElement.innerHTML = string_constant.USERNAME_ERROR_MSG;
      this.loginInput.nativeElement.focus();
      return false;
      ...
      this.errorOccured = true;
      this.connectionStatus.nativeElement.innerHTML = string_constant.MEETING_ROOM_ERROR_MSG;
